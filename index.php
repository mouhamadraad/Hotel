...
$guests_res = mysqli_fetch_assoc($guests_q);
    ...
    // Loop to create the options for the 'adult' select element
    ...
    <div class="swiper-wrapper mb-5">
      <div class="swiper-slide bg-white p-4">
        <div class="profile d-flex align-items-center mb-3">
          <img src="images/facilities/star.svg" width="30px" alt="Star">
          <h6 class="m-0 ms-2">Random user1</h6>
        </div>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic impedit cumque ex eos minima, vero officia deleniti reprehenderit dolor quod?</p>
        <div class="rating">
          <i class="bi bi-star-fill text-warning"></i>
          <i class="bi bi-star-fill text-warning"></i>
          <i class="bi bi-star-fill text-warning"></i>
...
<div class="container">
    <div class="row">
  <div class="col-lg-8 col-md-8 p-3 mb-lg-0 mb-3 rounded" style="background-color: rgba(255, 255, 255, 0.9); box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.1);">
  <iframe class="w-100 rounded" src="<?php echo $contact_r['iframe']?>" 
    loading="lazy" height="400px"></iframe>
        </div>

        <div class="col-lg-4 col-md-4 d-flex flex-column justify-content-between">
            <div class="bg-white p-4 rounded mb-4" style="background-color: rgba(255, 255, 255, 0.9); box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.1);">
                <h5> Call us</h5>
...
?>
            ...
            <div class="bg-white p-2 rounded mb-0" 
            style="background-color: rgba(255, 255, 255, 0.9); box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.1);">
                <h5> Follow us</h5>
              
          <a href="<?php echo $contact_r['tw'] ?>" class="d-inline-block mb-4">
          ...
          <br>
                ...
                <br>
                <a href="<?php echo $contact_r['insta'] ?>" class="d-inline-block mb-4">
                  <span class="badge bg-light text-dark fs-6 p-2">
