...
<nav class="navbar navbar-expand-lg  navbar-dark  rounded shadow">
  <div class="container-fluid flex-lg-column align-item-stretch">
    ...
    <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#adminDrodown" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
