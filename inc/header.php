          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6  mb-3">
                ...
                <input type="file" name="profile" accept=".jpg, .png, .jpeg" class="form-control shadow-none" required>
              </div>
              ...
              <div class="col-md-6  mb-3">
                <label class="form-label">Password</label>
                <input type="password" name="pass" class="form-control shadow-none" autocomplete="current-password" required>
              </div>
              <div class="col-md-6  mb-3">
                <label class="form-label">Confirm password</label>
                <input type="password" name="cpass" class="form-control shadow-none" autocomplete="new-password"required>
              </div>
            </div>
          </div>
        </div>
        <div class="text-center my-1">
          <button class="btn btn-dark shadow-none" type="submit" name="register" value="Register">Register</button>
        </div>
      </form>
    </div>
  </div>
